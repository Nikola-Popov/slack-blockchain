...
public final class BeanConfigurationConstants {
	...
	public static final String CURRENCY_SELECT_DIALOG_TEXT_ELEMENT = "currencySelectDialogTextElement";
	public static final String EMAIL_DIALOG_TEXT_ELEMENT = "emailDialogTextElement";
}
